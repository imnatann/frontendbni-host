...
import { getWaitingApprovalsAdd, approveMerchant, rejectMerchant } from "../../../../services/approveMerchantService";
...
const ListNeedApproval: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setIsLoading(true);
      try {
        const response = await getWaitingApprovalsAdd({ type: 'Add', page });
